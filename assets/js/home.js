  ...
  return `
    <section class="hero hero--art" aria-labelledby="home-title">
      <h1 id="home-title" class="hero-art__headline">
        <span class="hero-art__arte"><span class="hero-art__a" style="position: relative; top: 0.05em; display: inline-block; font-size: 1.05em;">A</span><span class="hero-art__rte">rte</span></span>
