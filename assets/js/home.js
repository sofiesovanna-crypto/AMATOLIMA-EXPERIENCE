  ...
  return `
    <section class="hero hero--art" aria-labelledby="home-title">
      <h1 id="home-title" class="hero-art__headline">
        <span class="hero-art__arte"><span class="hero-art__a" style="position: relative; top: 0em; left: 0.02em; display: inline-block; transform: scale(0.95); transform-origin: right center;">A</span><span class="hero-art__rte" style="position: relative; top: -0.08em; left: -0.08em;">rte</span></span>
