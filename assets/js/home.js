...
function projectsTemplate() {
  ...
  return `<section class="project-index" id="projetos-selecionados" aria-labelledby="project-index-title"><div class="project-index__heading-wrap"><h2 class="project-index__heading" id="project-index-title"><span class="project-index__line project-index__line--one">São Paulo,</span><span class="project-index__line project-index__line--two">sob o olhar</span><span class="project-index__line project-index__line--three">Amato Lima</span></h2></div><div class="project-index__list-wrap"><figure class="project-index__feature"><img src="assets/images/sections-home/31811.jpg" alt="São Paulo sob o olhar Amato Lima" loading="lazy" /></figure><ul class="project-index__list" aria-label="Projetos selecionados">${projectRows}</ul></div></section>`;
}
